/*
 * Copied from apps/coffee/lib/image.ts on 2026-09-22, unchanged below this
 * comment. A copy rather than an import because apps here share nothing but
 * the stamped files in packages/shared, and this is not one of them. If it
 * earns a third user, that is the moment to propose stamping it.
 *
 * Here it shrinks a photo of a recipe before the "From a file" upload, for
 * Coffee's three reasons: HEIC, the API's accepted types, and Vercel's body cap.
 */
/**
